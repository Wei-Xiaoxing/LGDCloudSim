...
import org.lgdcloudsim.interscheduler.wxl.*;
 ...
 */
public class InterSchedulerWxl implements InterScheduler {
    /**
     ...
     */
    public Logger LOGGER = LoggerFactory.getLogger(InterSchedulerWxl.class.getName());

    /**
     * The target of the inter-scheduler.
     * It can be set to {@link InterSchedulerWxl#HOST_TARGET}, {@link InterSchedulerWxl#DC_TARGET} or {@link InterSchedulerWxl#MIXED_TARGET}.
     */
    @Getter
    int target;

    /**
     * It is used when the target is {@link InterSchedulerWxl#DC_TARGET} or {@link InterSchedulerWxl#MIXED_TARGET}.
     ...
     * @param target the target of the inter-scheduler, it can be set to {@link InterSchedulerWxl#HOST_TARGET}, {@link InterSchedulerWxl#DC_TARGET} or {@link InterSchedulerWxl#MIXED_TARGET}
     * @param isSupportForward whether the scheduled instance group by the inter-scheduler supports forward
     */
    public InterSchedulerWxl(int id, Simulation simulation, int collaborationId, int target, boolean isSupportForward) {
        this.id = id;
