...
//                    tp
    ...
    private void finishInstance(Instance instance) {
        assert (instance.getInstanceGroup().getReceiveDatacenter().getId() != -1 || instance.getInstanceGroup().getState()==UserRequest.FAILED);
...
//        System.out.println((instance.getInstanceGroup().getReceiveDatacenter().getId() != -1)+":"+ (instance.getInstanceGroup().getState()==UserRequest.FAILED));
//        assert (instance.getInstanceGroup().getReceiveDatacenter().getId() != -1 || instance.getInstanceGroup().getState()==UserRequest.FAILED);
...
//                System.out.println(dstInstanceGroup);
//                System.out.println(instanceGroup.getReceiveDatacenter());
...
//            System.out.println("test5, process pre allocate resource");
    ...
    private Map<IntraScheduler, List<Instance>> allocateResource(Map<IntraScheduler, List<Instance>> allocatedResult) {
        ...
        for (Map.Entry<IntraScheduler, List<Instance>> entry : allocatedResult.entrySet()) {
            ...
            for (Instance instance : instances) {
                ...
                assert instance.getInstanceGroup().getReceiveDatacenter().getId() != -1;
...
//        System.out.println("send finish instance run evt from allocate resource");
...
//                System.out.println("test5, process intra schedule end");
                startIntraScheduling(intraScheduler);
            } else {
...
//            System.out.println("start intra scheduling");
...
//                    System.out.println("intra load balance");
...
//                    System.out.println("inter load balance");
...
//        System.out.println("send finish instance run evt from allocate resource for instance group");
...
//            for (Map.Entry<Datacenter, List<InstanceGroup>> scheduledResult : interSchedulerResult.getScheduledResultMap().entrySet()) {
//                assert scheduledResult.getKey().getId()!=-1;
//            }
...
//            System.out.println("start inter scheduling");
